...
const NeedyNav = ({ donorEmail }) => {
  ...
  return (
    <nav className="bg-gradient-to-r from-green-50 to-blue-50 shadow-lg p-4 font-sans relative z-10">
      <div className="container mx-auto flex justify-between items-center">
        ...
        {/* Email Display */}
        {email && (
          <div className="hidden md:block text-lg font-medium text-gray-700 px-4 py-2 rounded-full bg-white shadow-sm">
        ...
        <div className="flex space-x-4 lg:space-x-6 items-center">
          ...
          <input
            ...
            className="px-4 py-2 rounded-full text-base font-medium text-gray-700 bg-white shadow-sm
                       ...
                       transition duration-300 ease-in-out transform hover:scale-105"
            value="NeedyDesk"
            onClick={() => doNavigate('needynav')} // Navigates to '/'
          />
